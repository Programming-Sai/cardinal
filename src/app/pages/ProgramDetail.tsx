      ...
      <section className="pt-[120px] pb-20 bg-[#f7fafd] min-h-screen">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16">
          <div className="bg-white border border-[#e6bcbf] p-10 shadow-xl">
            <h1 className="font-bold text-[36px] sm:text-[40px] md:text-[48px] text-[#0A1C3A] mb-4">Loading program</h1>
          </div>
        </div>
      </section>
    );
              ...
              <div className="bg-white border border-[#e6bcbf] p-8 shadow-xl">
                <div className="grid grid-cols-2 gap-6 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-[#0A1C3A]">{program.deadline || 'Rolling'}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-3">
                      {includes.map((item) => (
                        <li key={typeof item === 'string' ? item : item.label} className="flex items-start gap-3 text-[#737576]">
                ...
                {timeline.map((item, index) => {
                  ...
                  return (
                    <div key={entry.label} className="flex gap-4">
                      ...
                      <div>
                        <h3 className="font-bold text-[#0A1C3A] mb-1">{entry.label}</h3>
                        <p className="text-[#737576] leading-7">{entry.description}</p>
                      </div>
                    </div>
                  );
                })}
