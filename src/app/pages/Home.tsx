...
export default function Home() {
  ...
  const programCards = programs.slice(0, 3).map((program, index) => ({
    ...
    title: program.title,
    description:
      program.summary || program.tagline || program.description || "Learn more about this program.",
  ...
  return (
    <>
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 grid grid-cols-1 md:grid-cols-2 gap-6 items-center relative z-10">
          <div className="space-y-8 reveal active">
            <h1 className="font-extrabold text-[32px] md:text-[64px] leading-[40px] md:leading-[72px] tracking-[-0.02em] text-[#181c1e]">
              Structured International Learning.{" "}
              <span className="text-[#F71C56]">And Tourism.</span>
            </h1>
            <p className="text-lg leading-7 text-[#737576] max-w-lg">
              Cardinal Immersions designs cross-border educational programs for
              students, professionals, and institutions, fostering real-world
              expertise and global competence.
            </p>
          ...
          <div className="flex justify-center items-center reveal active">
            <div className="w-full max-w-[500px] h-[320px] sm:h-[400px] lg:h-[500px] relative">
              ...
              >
                ...
                />
                <path
                  d="M 230 220 Q 240 210 250 220 Q 260 210 270 220 L 265 240 L 235 240 Z"
                  fill="#F71C56"
                  opacity="0.3"
                />
                <path
                  d="M 220 260 Q 230 250 240 260 L 235 280 L 225 280 Z"
                  fill="#F71C56"
                  opacity="0.3"
                />
                <path
                  d="M 260 265 Q 270 255 280 265 L 275 285 L 265 285 Z"
                  fill="#F71C56"
                  opacity="0.3"
                />
              </svg>
      ...
      {/* 3. Core Purpose */}
      <section
        className="py-[120px] bg-[#f7fafd] relative -mt-20 z-10"
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 text-center relative z-10 py-12">
          <div className="max-w-4xl mx-auto space-y-5 sm:space-y-6 reveal">
            ...
            <p className="text-[32px] leading-relaxed font-semibold text-[#0A1C3A]">
              We sit at the intersection of education, professional development,
              and international exchange. International mobility is a tool for
              learning, capability development, and institutional collaboration
              - one that shapes perspective, builds competence, and deepens
              understanding.
            </p>
          </div>
        </div>
      ...
      {/* 4. Our Distinction */}
      <section
        className="py-[120px] bg-[#f7fafd] relative -mt-20 pt-40 pb-40 overflow-hidden"
        style={{ clipPath: "polygon(0 10%, 100% 0, 100% 90%, 0 100%)" }}
      >
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-[#e6bcbf] bg-white overflow-hidden shadow-2xl">
            <div
              className="p-12 md:p-16 border-b md:border-b-0 md:border-r border-[#e6bcbf]"
              style={{
                maskImage:
            ...
            >
              <h3 className="font-semibold text-[32px] leading-[40px] mb-8 text-[#0A1C3A]">
                What we{" "}
                <span className="text-[#F71C56] font-extrabold italic">
                  ARE
                </span>
              </h3>
            ...
            <div
              className="p-12 md:p-16 bg-[#f1f4f7]"
              style={{
                maskImage:
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 py-20">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 reveal">
            ...
            <div className="mt-8 md:mt-0">
              <Link
                className="font-bold text-[#F71C56] underline underline-offset-8 decoration-2 hover:opacity-70 transition-all"
                to="/programs"
              >
                View all programs
              </Link>
            ...
            {isLoadingPrograms ? (
              Array.from({ length: 3 }).map((_, index) => (
                <div
                  ...
                  className="bg-white p-8 border border-[#e6bcbf] animate-pulse"
                  style={{
                    borderTop: "6px solid #e6bcbf",
                    clipPath: "polygon(0 0, 95% 0, 100% 5%, 100% 100%, 5% 100%, 0 95%)",
                  }}
                >
                  <div className="w-12 h-12 bg-[#e6bcbf] mb-6" />
                  <div className="h-7 w-2/3 bg-[#e6bcbf] mb-4" />
                  <div className="h-4 w-full bg-[#eef1f4] mb-2" />
                  <div className="h-4 w-5/6 bg-[#eef1f4] mb-8" />
              ...
              programCards.map((program, index) => (
                ...
                >
                  ...
                  <h4 className="font-semibold text-[24px] mb-4 text-[#0A1C3A]">
                    {program.title}
                  </h4>
      ...
      {/* 6. Mission & Vision */}
      <section
        className="py-[120px] overflow-hidden bg-[#f7fafd] relative -mt-16 z-0 pt-40"
        style={{ clipPath: "polygon(0 10%, 100% 0, 100% 90%, 0 100%)" }}
      >
              ...
              <div className="relative z-10 space-y-12">
                <div className="reveal">
                  ...
                  <p className="font-semibold text-[32px] leading-[40px] text-[#0A1C3A] italic border-l-4 border-[#F71C56] pl-8">
                    To design and deliver immersive international programs that
                    integrate education, professional practice, and cultural
                    intelligence, ensuring participants gain tangible learning
                    outcomes and globally relevant perspectives.
                  </p>
                </div>
                <div className="reveal">
                  <span className="font-bold text-[#F71C56] uppercase tracking-[0.2em] mb-4 block">
                  ...
                  <p className="font-semibold text-[32px] leading-[40px] text-[#0A1C3A] italic border-l-4 border-[#0A1C3A] pl-8">
                    Become a globally respected, African-founded learning
                    platform that positions Africa as both a source of talent
                    and a destination for high-quality learning.
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* 7. Trust Signals */}
      <section
        className="py-[120px] bg-[#f1f4f7] border-b border-[#e6bcbf] relative z-10"
        style={{ clipPath: "polygon(0 10%, 100% 0, 100% 90%, 0 100%)" }}
      >
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 py-12">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-20">
            <div className="text-center reveal">
              <p className="font-extrabold text-[40px] sm:text-[56px] md:text-[64px] leading-[48px] sm:leading-[64px] md:leading-[72px] tracking-[-0.02em] text-[#F71C56] mb-1">
                10+
              </p>
              <p className="font-bold text-[#0A1C3A] uppercase tracking-widest text-sm">
                Countries
              </p>
            </div>
            <div
              ...
              style={{ transitionDelay: "100ms" }}
            >
              <p className="font-extrabold text-[40px] sm:text-[56px] md:text-[64px] leading-[48px] sm:leading-[64px] md:leading-[72px] tracking-[-0.02em] text-[#0A1C3A] mb-1">
                500+
              </p>
              <p className="font-bold text-[#0A1C3A] uppercase tracking-widest text-sm">
                Participants
            ...
            <div className="col-span-1">
              ...
              >
                <p className="text-base italic mb-6">
                  Cardinal Immersions provided a level of rigor we hadn&apos;t
                  seen in other exchange programs. This was truly about
                  learning, not a vacation.
                </p>
                <p className="font-bold text-[#0A1C3A]">
                  Director of International Programs, University of Lagos
                </p>
              </div>
            </div>
