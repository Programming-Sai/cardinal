...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-white/80">
            Dedicated to international learning mobility, not tourism. Academic
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative">
